...
const explore = ({ data }) => {
    ...
    return (
        <div>
            ...
            <div className="w-full pb-10 pt-24 px-32 gap-4 flex max-md:px-6 max-xl:px-12 max-sm:px-4 max-lg:px-12">
                ...
                <div className="w-5/6 flex flex-col">
                    ...
                    <div className="flex justify-center flex-wrap gap-2 w-full h-1/3 mt-10">
