    ...
    return (
        <Layout>
            ...
            <section className="w-3/4 max-sm:w-10/12 flex  mx-auto flex-col gap-8 ">
                <div className="title">
                    <h1 className="max-sm:w-full text-gray-800 text-2xl home_button pb-2 max-sm:text-xl">WELCOME TO <Link href={"/"}><span className="text-3xl max-sm:text-2xl uppercase home_button tracking-tighter text-[#843fe7]">skillsphere</span></Link></h1>
                    <p className="w-5/6 max-xl:w-full max-sm:w-full mx-auto home_text2 text-base max-sm:text-sm text-gray-600 ">Join skillsphere for Free and explore the new learing experience</p>
                </div>
                <form className="flex flex-col  items-center gap-5">
                    <div className="w-full input-group relative flex items-center home_text2 text-base max-sm:text-sm">
                        <input className="w-full px-4 py-2 rounded border-2 border-rose-400 focus:border-rose-500 focus:ring-1 focus:ring-rose-500 pr-10 outline-none" type="email"
                            name="email"
                            placeholder="Email"
                        />
                    ...
                    <div className="w-full input-group relative flex items-center text-base max-sm:text-sm home_text2 ">
                        <input className="w-full px-4 py-2 rounded border-2 border-rose-400 focus:border-rose-500 focus:ring-1 focus:ring-rose-500 pr-10 outline-none" type={`${show?"text":"password"}`}
                            name="password"
                    ...
                    <div className="input-button home_text2 w-full text-gray-800 border-2 border-rose-400 hover:bg-rose-400 hover:text-white py-2  rounded">
                        <button onClick={handleGoogleSignIn} type="submit" className="flex items-center justify-center w-full ">
                            <span className="max-sm:text-sm">Sign in with Google</span>
                    ...
                    <div className="input-button home_text2 w-full text-gray-800 border-2 border-rose-400 hover:bg-rose-400 hover:text-white py-2  rounded">
                        <button onClick={handleGithubSignIn} type="submit" className="flex items-center justify-center w-full ">
                            <span className="max-sm:text-sm">Sign in with Github</span>
                            <span className="ml-1"><AiOutlineGithub size={22}/>
                            </span>
                        </button>
                    </div>
                </form>
                <p className="text-center text-gray-600 home_text2 max-sm:text-sm">Don't have an account yet?<Link href={'/register'} className="text-blue-700 hover:underline">Sign up</Link> </p>
